...
def build_dynamic_pvd_svg(
    ...
    <svg viewBox="0 0 680 360" width="100%" xmlns="http://www.w3.org/2000/svg"
      ...
      <!-- Bottom drainage arrows -->
      <g class="vertical-arrow" stroke="#67E8F9" stroke-width="3"
         stroke-linecap="round" stroke-linejoin="round"
         filter="url(#softGlow)">
        <path d="M123 288 V307 M116 300 L123 308 L130 300"/>
        <path d="M233 288 V307 M226 300 L233 308 L240 300"/>
        <path d="M343 288 V307 M336 300 L343 308 L350 300"/>
        <path d="M453 288 V307 M446 300 L453 308 L460 300"/>
        <path d="M563 288 V307 M556 300 L563 308 L570 300"/>
      </g>
